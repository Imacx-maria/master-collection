...
- Operational local knowledge belongs here when it is stable enough to reuse, as in `references/PROJECT_DOCS_BOOTSTRAP.md` and `references/GOOGLE_ACCOUNTS_MAP.md`.
