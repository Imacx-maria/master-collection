# Jocril Technical Review Checks

Load during Phase 4 when the chosen style is Jocril Technical.
...
- Hero typography too small — Jocril lives and dies by the scale jumps
