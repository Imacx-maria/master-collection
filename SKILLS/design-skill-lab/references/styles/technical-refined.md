...
A refined, technical aesthetic that emphasizes clarity, precision, and thoughtful interaction design — built for SaaS products, AI tools, developer tools, dashboards, and technical landing pages.

## Best for

- SaaS landing pages (B2B and developer-facing B2C)
- AI tools, agent platforms, ML-ops products
- Developer tools, CLIs, IDEs, code-adjacent products
- Dashboards and admin interfaces
- API documentation sites and changelog pages
- Fintech and infrastructure products that need to feel "competent engineering"
- Technical podcasts, newsletters, blogs in the dev/AI space

**Avoid for:** kids products, consumer hospitality, healthcare consumer-facing, fashion, anything where warmth and humanity should dominate over precision.

## Display Typography & Hero Patterns

This system is built on dramatic typographic scaling. The display tokens are not optional decoration — they are the system's core voice.
...
The This design system uses a **teal/cyan accent palette** as the primary brand color - NOT purple gradients.
...
Source: `/mnt/skills/user/technical-refined/assets/`
